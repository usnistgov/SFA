...
# AP209
  ...
  lappend inverses [list surface_3d_element_boundary_constant_specified_variable_value defined_state used_in]
  lappend inverses [list surface_3d_element_boundary_constant_specified_variable_value element used_in]
  ...
  lappend inverses [list volume_3d_element_boundary_constant_specified_variable_value defined_state used_in]
  lappend inverses [list volume_3d_element_boundary_constant_specified_variable_value element used_in]
  lappend inverses [list volume_3d_element_boundary_edge_constant_specified_variable_value defined_state used_in]
  lappend inverses [list volume_3d_element_boundary_edge_constant_specified_variable_value element used_in]
  lappend inverses [list volume_3d_element_location_point_volume_variable_values defined_state used_in]
  lappend inverses [list volume_3d_element_location_point_volume_variable_values element used_in]
