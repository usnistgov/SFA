...
# indent on these STEP entities
  set indentdat1 [list \
    ...
    CC_DESIGN CONSTRUCTIVE_GEOMETRY_REPRESENTATION_RELATIONSHIP CONTROL_LINEAR_STATIC_ANALYSIS_STEP CONTROL_LINEAR_STATIC_LOAD_INCREMENT_PROCESS CYLINDRICAL_PAIR_WITH_RANGE \
