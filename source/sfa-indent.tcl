...
# indent on these STEP entities
  set indentdat1 [list \
    ...
    CC_DESIGN CONSTRUCTIVE_GEOMETRY_REPRESENTATION_RELATIONSHIP CYLINDRICAL_PAIR_WITH_RANGE \
    ...
    SECURITY_CLASSIFICATION SHAPE_ASPECT_RELATIONSHIP SHAPE_DEFINING_RELATIONSHIP SHAPE_DEFINITION_REPRESENTATION SHAPE_REPRESENTATION_RELATIONSHIP \
    SINGLE_POINT_CONSTRAINT_ELEMENT_VALUES STRATUM_FEATURE STRUCTURAL_RESPONSE_PROPERTY \
...
# stop indenting when these entities are encountered
  set indentdat2 [list \
    ...
    SINGLE_AREA_CSG SINGLE_BOUNDARY_CSG STYLED_ITEM SURFACE_3D_ELEMENT_REPRESENTATION \
  ...
  outputMsg "Indenting: [truncFileName [file nativename $ifile] 1]"
...
# user-defined directory
  ...
  puts $indentWriteFile "Generated by the NIST STEP File Analyzer (v[getVersion])  [clock format [clock seconds]]\n"
