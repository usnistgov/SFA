...
# indent on these STEP entities
  set indentdat1 [list \
    ...
    DATA_QUALITY DATUM DRAUGHTING_CALLOUT DRAUGHTING_MODEL DIMENSIONAL_CHARACTERISTIC_REPRESENTATION DOCUMENT_PRODUCT_EQUIVALENCE \
    ...
    SECURITY_CLASSIFICATION SHAPE_ASPECT_RELATIONSHIP SHAPE_DEFINING_RELATIONSHIP SHAPE_DEFINITION_REPRESENTATION SHAPE_REPRESENTATION_RELATIONSHIP STRATUM_FEATURE STRUCTURAL_RESPONSE_PROPERTY \
