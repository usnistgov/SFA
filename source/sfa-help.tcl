...
3D scanning point clouds are supported in AP242.
...
assembly, the COPS might have the wrong position and orientation.  Point cloud colors and
intensities are not supported.
