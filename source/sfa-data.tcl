...
# -----------------------------------------------------------------------------------------------------
# entity attributes that cause a crash, LIST of LIST, something of something
...
set entCategory(PR_STEP_CPNT) [list cartesian_point coordinates_list node]
...
character_glyph_font_usage character_glyph_style_outline character_glyph_style_stroke character_glyph_symbol character_glyph_symbol_outline character_glyph_symbol_stroke \
...
drawing_definition drawing_revision drawing_revision_sequence drawing_sheet_layout drawing_sheet_revision drawing_sheet_revision_sequence \drawing_sheet_revision_usage \
...
planar_pair_value planar_pair_with_range planar_shape_representation \
...
context_dependent_shape_representation csg_shape_representation curve_swept_solid_shape_representation \
...
assembly_joint atom_based_literal b_spline_basis b_spline_curve_knot_locator b_spline_curve_segment b_spline_function b_spline_surface_knot_locator \
b_spline_surface_patch b_spline_surface_strip basic_sparse_matrix binary_assembly_constraint binary_literal boolean_result_2d \
bound_parameter_environment bound_variational_parameter boundary_curve_of_b_spline_or_rectangular_composite_surface cartesian_complex_number_region \
...
disallowed_assembly_relationship_usage disconnected_face_set discontinuous_geometry eccentric_cone edge_with_excessive_segments elementary_function \
elementary_space ellipsoid elliptic_area entirely_narrow_face entirely_narrow_solid entirely_narrow_surface equal_parameter_constraint \
...
externally_listed_data extreme_instance extreme_patch_width_variation face_shape_representation_relationship \
face_surface_with_excessive_patches_in_one_direction faceted_primitive feature_definition_with_connection_area finite_function finite_integer_interval \
...
single_area_csg_2d_shape_representation single_boundary_csg_2d_shape_representation single_property_is_definition \
...
complex_clause complex_conjunctive_clause complex_disjunctive_clause complex_shelled_solid concat_expression concept_feature_operator \
...
direction_shape_representation div_expression document document_file document_identifier document_identifier_assignment \
...
element_delivery elementary_brep_shape_representation entity_assertion enum_reference_prefix environment equals_expression \
...
face_shape_representation fact_type feature_in_panel featured_shape format_function forward_chaining_rule forward_chaining_rule_premise \
...
like_expression literal_conjunction literal_disjunction literal_number local_time location_shape_representation locator log_function \
...
product_material_composition_relationship product_process_plan product_related_product_category product_specification \
...
shape_defining_relationship shape_feature_definition shell_based_wireframe_model shell_based_wireframe_shape_representation shelled_solid \
...
slash_expression solid_curve_font solid_with_angle_based_chamfer solid_with_chamfered_edges solid_with_circular_pattern \
...
structured_text_composition structured_text_representation substring_expression supplied_part_relationship surfaced_open_shell symbol \
...
value_function variable variable_semantics versioned_action_request versioned_action_request_relationship vertex_shell \
