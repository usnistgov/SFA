...
foreach item [list \
  ...
  "statistical_tolerance <ST> (6.9.3)" "separate_requirement SEP REQT (6.9.3)" "intersection/orientation plane indicator" \
  "dimensions (Row 38+39)" "dimensional location (5.1.1)" "dimensional size (5.1.5)" "angular location (5.1.2)" "angular size (5.1.6)" \
  ...
  "dimension basic (5.3)" "reference dimension (5.3)" "statistical_dimension <ST> (5.3)" "type qualifier (5.2.2)" "tolerance class (5.2.5)" \
  "location with path (5.1.7)" "square \u25A1 (5.3)" "dimension qualifier (5.4)" \
...
#set pmfirst [list maximum_material_requirement least_material_requirement simultaneous_requirement counterbore depth hole_thread countersink slope conical_taper arc_length]
...
boundary_curve boundary_curve_of_b_spline_or_rectangular_composite_surface bounded_curve bounded_pcurve bounded_surface bounded_surface_curve \
box_domain boxed_half_space brep_with_voids cartesian_transformation_operator cartesian_transformation_operator_2d cartesian_transformation_operator_3d \
circle circular_involute closed_shell clothoid complex_shelled_solid complex_triangulated_face complex_triangulated_surface_set composite_curve \
composite_curve_on_surface composite_curve_segment conic conical_surface connected_edge_set connected_face_set connected_face_sub_set convex_hexahedron \
csg_primitive_solid_2d csg_solid csg_solid_2d cubic_bezier_tessellated_edge cubic_bezier_triangulated_face cubic_tessellated_connecting_edge curve \
curve_bounded_surface curve_replica cyclide_segment_solid cylindrical_point cylindrical_surface cylindrical_volume degenerate_pcurve degenerate_toroidal_surface \
direction dupin_cyclide_surface eccentric_cone eccentric_conical_volume edge edge_based_wireframe_model edge_curve edge_loop edge_with_length elementary_surface \
ellipse ellipsoid ellipsoid_volume evaluated_degenerate_pcurve extruded_area_solid extruded_face_solid face face_based_surface_model face_bound face_outer_bound \
face_surface faceted_brep faceted_primitive fixed_reference_swept_surface geometric_curve_set geometric_set half_space_solid hexahedron_volume hyperbola \
intersection_curve line local_b_spline locally_refined_spline_curve locally_refined_spline_surface locally_refined_spline_volume loop manifold_solid_brep \
offset_curve_2d offset_curve_3d offset_surface open_path open_shell oriented_closed_shell oriented_edge oriented_face oriented_open_shell oriented_path \
oriented_surface outer_boundary_curve parabola path pcurve placement planar_box planar_extent plane point point_and_vector point_array point_cloud_dataset \
point_cloud_dataset_with_colours point_cloud_dataset_with_intensities point_cloud_dataset_with_normals point_cloud_superdataset point_in_volume point_on_curve \
point_on_surface point_replica polar_point poly_loop polyline pyramid_volume quasi_uniform_curve quasi_uniform_surface quasi_uniform_volume rational_b_spline_curve \
rational_b_spline_surface rational_b_spline_volume rational_locally_refined_spline_curve rational_locally_refined_spline_surface \
rational_locally_refined_spline_volume rectangular_composite_surface rectangular_pyramid rectangular_trimmed_surface reparametrised_composite_curve_segment \
repositioned_tessellated_item revolved_area_solid revolved_face_solid right_angular_wedge right_circular_cone right_circular_cylinder ruled_surface_swept_area_solid \
seam_curve seam_edge shell_based_surface_model shell_based_wireframe_model shelled_solid solid_curve_font solid_model solid_replica solid_with_angle_based_chamfer \
solid_with_chamfered_edges solid_with_circular_pattern solid_with_circular_pocket solid_with_circular_protrusion solid_with_conical_bottom_round_hole \
solid_with_constant_radius_edge_blend solid_with_curved_slot solid_with_depression solid_with_double_offset_chamfer solid_with_flat_bottom_round_hole \
solid_with_general_pocket solid_with_general_protrusion solid_with_groove solid_with_hole solid_with_incomplete_circular_pattern \
solid_with_incomplete_rectangular_pattern solid_with_pocket solid_with_protrusion solid_with_rectangular_pattern solid_with_rectangular_pocket \
solid_with_rectangular_protrusion solid_with_shape_element_pattern solid_with_single_offset_chamfer solid_with_slot solid_with_spherical_bottom_round_hole \
...
solid_with_through_depression solid_with_trapezoidal_section_slot solid_with_variable_radius_edge_blend source_for_requirement sphere spherical_point \
spherical_surface spherical_volume subedge subface surface surface_curve surface_curve_swept_area_solid surface_curve_swept_surface surface_of_linear_extrusion \
surface_of_revolution surface_patch surface_replica surfaced_open_shell swept_area_solid swept_disk_solid swept_face_solid swept_surface tessellated_connecting_edge \
tessellated_curve_set tessellated_edge tessellated_face tessellated_geometric_set tessellated_item tessellated_point_set tessellated_shell tessellated_solid \
tessellated_structured_item tessellated_surface_set tessellated_vertex tessellated_wire tetrahedron tetrahedron_volume toroidal_surface toroidal_volume torus \
triangulated_face triangulated_point_cloud_dataset triangulated_surface_set trimmed_curve uniform_curve uniform_surface uniform_volume vector vertex vertex_loop \
...
all_around_shape_aspect apex assembly_shape_constraint assembly_shape_joint between_shape_aspect centre_of_symmetry component_path_shape_aspect \
composite_group_shape_aspect composite_shape_aspect composite_unit_shape_aspect connectivity_definition constituent_shape_aspect contact_feature \
continuous_shape_aspect derived_shape_aspect extension geometric_alignment geometric_contact geometric_intersection geometric_item_specific_usage \
item_identified_representation_usage parallel_offset perpendicular_to shape_aspect shape_aspect_associativity shape_aspect_deriving_relationship \
shape_aspect_occurrence shape_aspect_relationship shape_aspect_relationship_representation_association shape_aspect_transition symmetric_shape_aspect tangent]]
...
camera_image_2d_with_scale camera_image_3d_with_scale camera_model camera_model_d2 camera_model_d3 camera_model_d3_multi_clipping \
camera_model_d3_multi_clipping_intersection camera_model_d3_multi_clipping_union camera_model_d3_with_hlhsr camera_model_with_light_sources camera_usage \
...
character_glyph_symbol_stroke colour colour_rgb colour_specification composite_text composite_text_with_associated_curves composite_text_with_blanking_box \
composite_text_with_delineation composite_text_with_extent context_dependent_invisibility context_dependent_over_riding_styled_item curve_dimension curve_style \
curve_style_font curve_style_font_and_scaling curve_style_font_pattern curve_style_rendering datum_feature_callout datum_target_callout defined_character_glyph \
defined_symbol diameter_dimension dimension_callout dimension_callout_component_relationship dimension_callout_relationship dimension_curve \
dimension_curve_directed_callout dimension_curve_terminator dimension_pair dimension_related_tolerance_zone_element dimension_text_associativity \
...
draughting_model_item_association_with_placeholder draughting_pre_defined_colour draughting_pre_defined_curve_font draughting_pre_defined_text_font \
...
drawing_sheet_revision_usage externally_defined_character_glyph externally_defined_class externally_defined_colour externally_defined_curve_font \
externally_defined_hatch_style externally_defined_item externally_defined_item_relationship externally_defined_marker externally_defined_style \
externally_defined_symbol externally_defined_terminator_symbol externally_defined_text_font externally_defined_tile_style fill_area_style fill_area_style_colour \
fill_area_style_hatching fill_area_style_tile_coloured_region fill_area_style_tile_curve_with_style fill_area_style_tile_symbol_with_style fill_area_style_tiles \
generic_character_glyph_symbol generic_literal geometrical_tolerance_callout hidden_element_over_riding_styled_item invisibility leader_curve \
leader_directed_callout leader_directed_dimension leader_terminator linear_dimension mechanical_design_and_draughting_relationship ordinate_dimension \
over_riding_styled_item point_style pre_defined_character_glyph pre_defined_colour pre_defined_curve_font pre_defined_dimension_symbol \
pre_defined_geometrical_tolerance_symbol pre_defined_item pre_defined_marker pre_defined_point_marker_symbol pre_defined_surface_condition_symbol \
pre_defined_surface_side_style pre_defined_symbol pre_defined_terminator_symbol pre_defined_text_font presentation_area presentation_layer_assignment \
presentation_representation presentation_set presentation_size presentation_style_assignment presentation_style_by_context presentation_view projection_curve \
projection_directed_callout radius_dimension structured_dimension_callout styled_item styled_tessellated_item_with_colours surface_condition_callout \
surface_rendering_properties surface_side_style surface_style_boundary surface_style_control_grid surface_style_fill_area surface_style_parameter_line \
surface_style_reflectance_ambient surface_style_reflectance_ambient_diffuse surface_style_reflectance_ambient_diffuse_specular surface_style_rendering \
surface_style_rendering_with_properties surface_style_segmentation_curve surface_style_silhouette surface_style_transparent surface_style_usage \
surface_texture_representation symbol_colour symbol_representation symbol_representation_map symbol_style symbol_target tagged_text_format tagged_text_item \
terminator_symbol tessellated_annotation_occurrence text_font text_font_family text_font_in_family text_literal text_literal_with_associated_curves \
text_literal_with_blanking_box text_literal_with_delineation text_literal_with_extent text_string_representation text_style text_style_for_defined_font \
text_style_with_box_characteristics text_style_with_mirror text_style_with_spacing user_defined_curve_font user_defined_marker user_defined_terminator_symbol \
...
angular_location angular_size angularity_tolerance circular_runout_tolerance coaxiality_tolerance common_datum concentricity_tolerance counterbore_hole_definition \
counterbore_hole_occurrence counterbore_hole_occurrence_in_assembly counterdrill_hole_definition counterdrill_hole_occurrence \
counterdrill_hole_occurrence_in_assembly countersink_hole_definition countersink_hole_occurrence countersink_hole_occurrence_in_assembly cylindricity_tolerance \
...
dimensional_location_with_path dimensional_size dimensional_size_with_datum_feature dimensional_size_with_path directed_dimensional_location directed_tolerance_zone \
explicit_composite_hole explicit_round_hole externally_defined_dimension_definition feature_for_datum_target_relationship flatness_tolerance geometric_tolerance \
geometric_tolerance_auxiliary_classification geometric_tolerance_relationship geometric_tolerance_with_datum_reference geometric_tolerance_with_defined_area_unit \
geometric_tolerance_with_defined_unit geometric_tolerance_with_maximum_tolerance geometric_tolerance_with_modifiers limits_and_fits line_profile_tolerance \
modified_geometric_tolerance non_uniform_zone_definition oriented_tolerance_zone parallelism_tolerance perpendicularity_tolerance placed_datum_target_feature \
plus_minus_tolerance position_tolerance projected_zone_definition projected_zone_definition_with_offset referenced_modified_datum roundness_tolerance \
runout_zone_definition runout_zone_orientation runout_zone_orientation_reference_direction shape_dimension_representation simplified_counterbore_hole_definition \
simplified_counterdrill_hole_definition simplified_countersink_hole_definition simplified_spotface_hole_definition spotface_definition spotface_hole_definition \
spotface_occurrence spotface_occurrence_in_assembly straightness_tolerance surface_profile_tolerance symmetry_tolerance tolerance_value tolerance_zone \
tolerance_zone_definition tolerance_zone_form tolerance_zone_with_datum total_runout_tolerance unequally_disposed_geometric_tolerance]]
...
percentage_laminate_table percentage_ply_definition ply_angle_representation ply_laminate_definition ply_laminate_sequence_definition ply_laminate_table \
ply_orientation_angle polar_11 reinforcement_orientation_basis smeared_material_definition thickness_laminate_definition thickness_laminate_table user_defined_11 \
...
gear_pair_range gear_pair_value gear_pair_with_range high_order_kinematic_pair homokinetic_pair initial_state interpolated_configuration_representation \
interpolated_configuration_segment item_link_motion_relationship kinematic_analysis_consistency kinematic_analysis_result kinematic_control \
...
kinematic_ground_representation kinematic_joint kinematic_link kinematic_link_representation kinematic_link_representation_association \
kinematic_link_representation_relation kinematic_loop kinematic_pair kinematic_path kinematic_path_defined_by_curves kinematic_path_defined_by_nodes \
kinematic_path_segment kinematic_property_definition kinematic_property_definition_representation kinematic_property_mechanism_representation \
kinematic_property_representation_relation kinematic_property_topology_representation kinematic_structure kinematic_topology_directed_structure \
kinematic_topology_network_structure kinematic_topology_structure kinematic_topology_substructure kinematic_topology_tree_structure linear_flexible_and_pinion_pair \
linear_flexible_and_planar_curve_pair linear_flexible_link_representation linear_path link_motion_relationship link_motion_representation_along_path \
link_motion_transformation low_order_kinematic_pair low_order_kinematic_pair_value low_order_kinematic_pair_with_motion_coupling low_order_kinematic_pair_with_range \
mechanism mechanism_base_placement mechanism_representation mechanism_state_representation pair_actuator pair_representation_relationship pair_value path_node \
planar_curve_pair planar_curve_pair_range planar_pair planar_pair_range planar_pair_value planar_pair_with_range point_on_planar_curve_pair \
point_on_planar_curve_pair_range point_on_planar_curve_pair_value point_on_planar_curve_pair_with_range point_on_surface_pair point_on_surface_pair_range \
point_on_surface_pair_value point_on_surface_pair_with_range point_to_point_path prescribed_path prismatic_pair prismatic_pair_range prismatic_pair_value \
prismatic_pair_with_range product_definition_kinematics product_definition_relationship_kinematics rack_and_pinion_pair rack_and_pinion_pair_range \
rack_and_pinion_pair_value rack_and_pinion_pair_with_range revolute_pair revolute_pair_range revolute_pair_value revolute_pair_with_range rigid_link_representation \
rolling_curve_pair rolling_curve_pair_value rolling_surface_pair rolling_surface_pair_value rotation_about_direction screw_pair screw_pair_range screw_pair_value \
screw_pair_with_range simple_pair_range sliding_curve_pair sliding_curve_pair_value sliding_surface_pair \
sliding_surface_pair_value spherical_pair spherical_pair_range spherical_pair_value spherical_pair_with_pin spherical_pair_with_pin_and_range \
spherical_pair_with_range surface_pair surface_pair_range surface_pair_with_range unconstrained_pair unconstrained_pair_value universal_pair \
universal_pair_range universal_pair_value universal_pair_with_range]]
...
date_representation_item date_time_representation_item derived_unit derived_unit_element derived_unit_variable descriptive_representation_item \
dielectric_constant_measure_with_unit dimensional_exponents dose_equivalent_measure_with_unit dose_equivalent_unit electric_charge_measure_with_unit \
electric_charge_unit electric_current_measure_with_unit electric_current_unit electric_potential_measure_with_unit electric_potential_unit \
energy_measure_with_unit energy_unit externally_defined_context_dependent_unit externally_defined_conversion_based_unit externally_defined_currency \
force_measure_with_unit force_unit frequency_measure_with_unit frequency_unit global_uncertainty_assigned_context global_unit_assigned_context \
illuminance_measure_with_unit illuminance_unit inductance_measure_with_unit inductance_unit integer_representation_item length_measure_with_unit length_unit \
logical_representation_item loss_tangent_measure_with_unit luminous_flux_measure_with_unit luminous_flux_unit luminous_intensity_measure_with_unit \
luminous_intensity_unit magnetic_flux_density_measure_with_unit magnetic_flux_density_unit magnetic_flux_measure_with_unit magnetic_flux_unit mass_measure_with_unit \
mass_unit measure_qualification measure_representation_item measure_with_unit named_unit named_unit_variable plane_angle_measure_with_unit plane_angle_unit \
positive_length_measure_with_unit positive_plane_angle_measure_with_unit power_measure_with_unit power_unit precision_qualifier pressure_measure_with_unit \
pressure_unit qualified_representation_item radioactivity_measure_with_unit radioactivity_unit ratio_measure_with_unit ratio_unit real_representation_item \
resistance_measure_with_unit resistance_unit si_absorbed_dose_unit si_capacitance_unit si_conductance_unit si_dose_equivalent_unit si_electric_charge_unit \
si_electric_potential_unit si_energy_unit si_force_unit si_frequency_unit si_illuminance_unit si_inductance_unit si_magnetic_flux_density_unit si_magnetic_flux_unit \
si_power_unit si_pressure_unit si_radioactivity_unit si_resistance_unit si_unit solid_angle_measure_with_unit solid_angle_unit thermal_resistance_measure_with_unit \
thermal_resistance_unit thermodynamic_temperature_measure_with_unit thermodynamic_temperature_unit time_measure_with_unit time_unit type_qualifier \
uncertainty_measure_with_unit uncertainty_qualifier value_format_type_qualifier value_representation_item velocity_measure_with_unit velocity_unit \
volume_measure_with_unit volume_unit]]
...
direction_shape_representation document_representation_type edge_based_wireframe_shape_representation elementary_brep_shape_representation \
externally_defined_general_property face_shape_representation face_shape_representation_relationship faceted_brep_shape_representation general_material_property \
general_property general_property_association general_property_relationship geometric_representation_context geometric_representation_item \
geometrically_bounded_2d_wireframe_representation geometrically_bounded_surface_shape_representation geometrically_bounded_wireframe_shape_representation \
hardness_representation item_defined_transformation location_shape_representation manifold_subsurface_shape_representation manifold_surface_shape_representation \
...
non_manifold_surface_shape_representation null_representation_item parametric_representation_context path_shape_representation picture_representation_item \
planar_shape_representation point_placement_shape_representation predefined_picture_representation_item presented_item_representation property_definition \
property_definition_relationship property_definition_representation rational_representation_item representation representation_context \
representation_context_reference representation_item representation_map representation_proxy_item representation_reference representation_relationship \
representation_relationship_with_transformation representative_shape_representation row_representation_item shape_definition_representation shape_representation \
shape_representation_reference shape_representation_relationship shape_representation_with_parameters shell_based_wireframe_shape_representation \
single_area_csg_2d_shape_representation single_boundary_csg_2d_shape_representation table_representation_item tactile_appearance_representation \
tessellated_shape_representation tessellated_shape_representation_with_accuracy_parameters topological_representation_item uncertainty_assigned_representation \
...
feature_component_definition feature_component_relationship feature_definition feature_pattern fillet hole_bottom instanced_feature linear_profile \
ngon_closed_profile open_path_profile outside_profile partial_circular_profile path_feature_component placed_feature pocket pocket_bottom rectangular_closed_profile \
rectangular_pattern replicate_feature revolved_profile rib round_hole rounded_u_profile slot slot_end square_u_profile tee_profile thread transition_feature \
vee_profile]]
...
a3m_equivalence_criterion_of_detailed_shape_data_content a3m_equivalence_criterion_of_representative_assembly_property_value \
...
a3m_equivalence_inspection_requirement_with_values a3m_equivalence_inspection_result_representation a3m_equivalence_inspection_result_representation_for_assembly \
a3m_equivalence_inspection_result_representation_for_shape a3m_equivalence_summary_report_request_with_representative_value \
a3m_inspected_model_and_inspection_result_relationship a3ma_assembly_and_shape_criteria_relationship a3ma_equivalence_criterion_assessment_threshold_relationship \
a3ma_equivalence_inspection_result a3ma_length_measure_and_context_dependent_measure_pair a3ms_equivalence_criterion_with_specified_elements \
a3ms_equivalence_inspection_result abrupt_change_of_surface_normal abstracted_expression_function action_directive_relationship action_resource_relationship \
add_element additive_manufacturing_build_plate_relationship additive_manufacturing_setup additive_manufacturing_setup_relationship \
additive_manufacturing_setup_workpiece_relationship additive_manufacturing_support_structure_geometry_relationship agc_with_dimension aggregate_id_attribute \
alternative_solution_relationship analysis_assignment analysis_item analysis_model analysis_representation_context angle_assembly_constraint_with_dimension \
angle_geometric_constraint ap242_assignment_object_relationship application_defined_function applied_classification_assignment_relationship \
applied_description_text_assignment applied_description_text_assignment_relationship applied_directed_action_assignment \
applied_external_identification_assignment_relationship applied_location_assignment applied_location_representation_assignment applied_organization_type_assignment \
applied_state_observed_assignment applied_state_type_assignment area_with_outer_boundary array_placement_group ascribable_state ascribable_state_relationship \
assembly_bond_definition assembly_component assembly_geometric_constraint assembly_group_component assembly_group_component_definition_placement_link assembly_joint \
assembly_shape_constraint_item_relationship assembly_shape_joint_item_relationship assigned_analysis assignment_object_relationship atom_based_literal \
attachment_slot_as_planned attachment_slot_as_realized attachment_slot_design attachment_slot_design_to_planned attachment_slot_design_to_realized \
attachment_slot_on_product attachment_slot_planned_to_realized banded_matrix basic_sparse_matrix binary_assembly_constraint binary_literal boolean_result_2d \
bound_parameter_environment bound_variable_semantics bound_variational_parameter cartesian_complex_number_region cdgc_with_dimension \
chain_based_geometric_item_specific_usage chain_based_item_identified_representation_usage change_composition_relationship change_element change_element_sequence \
change_group change_group_assignment characterized_chain_based_item_within_representation characterized_location_object characterized_object_relationship \
characterized_product_concept_feature characterized_product_concept_feature_category circular_area classification_assignment_relationship clgc_with_dimension \
closed_curve_style_parameters coaxial_assembly_constraint coaxial_geometric_constraint collection collection_assignment collection_membership collection_relationship \
collection_version collection_version_relationship collection_version_sequence_relationship collection_view_definition complex_area complex_number_literal \
complex_number_literal_polar component_definition component_feature component_feature_joint component_feature_relationship component_mating_constraint_condition \
component_terminal composite_curve_transition_locator condition conditional_effectivity connected_edge_with_length_set_representation connected_volume_set \
connected_volume_sub_set connection_zone_based_assembly_joint connection_zone_interface_plane_relationship connectivity_definition_item_relationship \
constant_function contact_feature_definition contact_feature_definition_fit_relationship contact_feature_fit_relationship contacting_feature containing_message \
criterion_report_item_with_number_of_instances criterion_report_item_with_value cross_sectional_alternative_shape_element cross_sectional_group_shape_element \
cross_sectional_group_shape_element_with_lacing cross_sectional_group_shape_element_with_tubular_cover cross_sectional_occurrence_shape_element \
cross_sectional_part_shape_element current_change_element_assignment curve_distance_geometric_constraint curve_length_geometric_constraint curve_segment_set \
curve_smoothness_geometric_constraint curve_style_parameters_representation curve_style_parameters_with_ends curve_with_excessive_segments \
curve_with_small_curvature_radius data_equivalence_assessment_specification data_equivalence_criteria_representation data_equivalence_criterion \
data_equivalence_definition data_equivalence_definition_relationship data_equivalence_definition_representation_relationship data_equivalence_inspected_element_pair \
data_equivalence_inspection_criterion_report data_equivalence_inspection_criterion_report_item data_equivalence_inspection_instance_report \
data_equivalence_inspection_instance_report_item data_equivalence_inspection_report data_equivalence_inspection_requirement data_equivalence_inspection_result \
data_equivalence_inspection_result_representation data_equivalence_inspection_result_with_judgement data_equivalence_report_request \
data_quality_assessment_measurement_association data_quality_assessment_specification data_quality_criteria_representation data_quality_criterion \
data_quality_criterion_assessment_association data_quality_criterion_measurement_association data_quality_definition data_quality_definition_relationship \
data_quality_definition_representation_relationship data_quality_inspection_criterion_report data_quality_inspection_criterion_report_item \
data_quality_inspection_instance_report data_quality_inspection_instance_report_item data_quality_inspection_report data_quality_inspection_result \
data_quality_inspection_result_representation data_quality_inspection_result_with_judgement data_quality_measurement_requirement \
data_quality_report_measurement_association data_quality_report_request default_model_geometric_view defined_constraint definite_integral_expression \
definite_integral_function definitional_product_definition_usage delete_element dependent_variable_definition description_text description_text_assignment \
description_text_assignment_relationship detailed_equivalence_report_request detailed_equivalence_report_request_with_number_of_instances detailed_report_request \
detailed_report_request_with_number_of_data different_angle_of_assembly_constraint different_assembly_centroid different_assembly_centroid_using_notional_solid \
different_assembly_constraint_type different_assembly_volume different_bounding_box different_centroid different_component_identification_via_multi_level_reference \
different_component_shape different_component_type different_curve_length different_length_of_assembly_constraint different_number_of_closed_shell \
different_number_of_components different_number_of_geometric_elements different_number_of_geometric_elements_wireframe_model different_number_of_topological_elements \
different_number_of_topological_elements_wireframe_model different_placement_of_component different_surface_area different_surface_normal different_volume \
directed_action_assignment disallowed_assembly_relationship_usage disconnected_face_set discontinuous_geometry draughting_specification_reference \
edge_with_excessive_segments elementary_function elementary_space elliptic_area entirely_narrow_face entirely_narrow_solid entirely_narrow_surface envelope \
envelope_relationship equal_parameter_constraint equivalence_instance_report_item_with_notable_instances equivalence_notable_instance \
erroneous_b_spline_curve_definition erroneous_b_spline_surface_definition erroneous_data erroneous_geometry erroneous_manifold_solid_brep erroneous_topology \
erroneous_topology_and_geometry_relationship evaluated_characteristic_of_product_as_individual_test_result evidence excessive_use_of_groups excessive_use_of_layers \
excessively_high_degree_curve excessively_high_degree_surface explicit_constraint explicit_geometric_constraint explicit_table_function expression_denoted_function \
expression_extension_numeric expression_extension_string expression_extension_to_select extended_tuple_space external_identification_assignment_relationship \
externally_conditioned_data_quality_criteria_representation externally_conditioned_data_quality_criterion \
...
externally_listed_data extreme_instance extreme_patch_width_variation face_surface_with_excessive_patches_in_one_direction feature_definition_with_connection_area \
final_solution finite_function finite_integer_interval finite_real_interval finite_space fixed_constituent_assembly_constraint fixed_element_geometric_constraint \
fixed_instance_attribute_set flat_face free_edge free_form_assignment free_form_constraint free_form_relation free_variable_semantics frozen_assignment \
function_application function_space g1_discontinuity_between_adjacent_faces g1_discontinuous_curve g1_discontinuous_surface g2_discontinuity_between_adjacent_faces \
g2_discontinuous_curve g2_discontinuous_surface gap_between_adjacent_edges_in_loop gap_between_edge_and_base_surface gap_between_faces_related_to_an_edge \
gap_between_pcurves_related_to_an_edge gap_between_vertex_and_base_surface gap_between_vertex_and_edge gear general_datum_reference general_linear_function \
generated_finite_numeric_space generic_product_definition_reference generic_property_relationship geometric_gap_in_topology \
geometric_representation_context_with_parameter geometry_with_local_irregularity geometry_with_local_near_degeneracy gps_filter gps_filtration_specification \
half_space_2d harness_node harness_segment hierarchical_interface_connection high_degree_axi_symmetric_surface high_degree_conic high_degree_linear_curve \
high_degree_planar_surface homogeneous_linear_function idrm_classification_assignment implicit_explicit_positioned_sketch_relationship implicit_intersection_curve \
implicit_model_intersection_curve implicit_planar_curve implicit_planar_intersection_point implicit_planar_projection_point implicit_point_on_plane \
implicit_projected_curve implicit_silhouette_curve imported_curve_function imported_point_function imported_surface_function imported_volume_function in_zone \
inappropriate_element_visibility inappropriate_use_of_layer inapt_data inapt_geometry inapt_manifold_solid_brep inapt_topology \
inapt_topology_and_geometry_relationship incidence_assembly_constraint incidence_geometric_constraint inconsistent_adjacent_face_normals \
inconsistent_curve_transition_code inconsistent_edge_and_curve_directions inconsistent_element_reference inconsistent_face_and_closed_shell_normals \
inconsistent_face_and_surface_normals inconsistent_surface_transition_code indistinct_curve_knots indistinct_surface_knots instance_attribute_reference \
instance_report_item_with_extreme_instances integer_interval_from_min integer_interval_to_max integer_tuple_literal interface_component interface_connection \
interface_connector_as_planned interface_connector_as_realized interface_connector_definition interface_connector_design interface_connector_design_to_planned \
interface_connector_design_to_realized interface_connector_occurrence interface_connector_planned_to_realized interface_connector_version \
interface_definition_connection interface_definition_for interface_specification_definition interface_specification_version interfaced_group_component \
...
linear_array_placement_group_component linearized_table_function listed_complex_number_data listed_data listed_integer_data listed_logical_data listed_product_space \
listed_real_data listed_string_data location location_assignment location_in_aggregate_representation_item location_relationship location_representation_assignment \
location_representation_role location_role machining_process_executable make_from_feature_relationship marking mated_part_relationship \
mathematical_description maths_boolean_variable maths_enum_literal maths_function maths_integer_variable maths_real_variable maths_space maths_string_variable \
maths_tuple_literal maths_variable mating_material mating_material_items mechanical_design_requirement_item_association message_contents_assignment \
message_contents_group message_relationship mismatch_of_arcwise_connected_curves mismatch_of_arcwise_connected_surfaces \
mismatch_of_arcwise_connected_surfaces_boundary mismatch_of_component mismatch_of_edges mismatch_of_faces mismatch_of_point_cloud_and_related_geometry \
mismatch_of_points mismatch_of_underlying_edge_geometry mismatch_of_underlying_face_geometry missing_assembly_constraint missing_component missing_edge missing_face \
model_geometric_view modify_element multi_level_reference_designator multiply_defined_cartesian_points multiply_defined_curves multiply_defined_directions \
...
nearly_degenerate_surface_patch neutral_sketch_representation non_agreed_accuracy_parameter_usage non_agreed_scale_usage non_agreed_unit_usage non_manifold_at_edge \
non_manifold_at_vertex non_referenced_coordinate_system non_smooth_geometry_transition_across_edge open_closed_shell open_edge_loop organization_type \
organization_type_assignment organization_type_role oriented_joint outer_round over_used_vertex overcomplex_geometry overcomplex_topology_and_geometry_relationship \
overlapping_geometry parallel_assembly_constraint parallel_assembly_constraint_with_dimension parallel_composed_function parallel_geometric_constraint \
...
path_parameter_representation_context pdgc_with_dimension perpendicular_assembly_constraint perpendicular_geometric_constraint pgc_with_dimension physical_component \
physical_component_feature physical_component_interface_terminal physical_component_terminal plane_angle_and_length_pair plane_angle_and_ratio_pair \
pmi_requirement_item_association pogc_with_dimension point_distance_geometric_constraint point_on_edge_curve point_on_face_surface polar_complex_number_region \
polygonal_area previous_change_element_assignment primitive_2d primitive_2d_with_inner_boundary procedural_solid_representation_sequence product_as_planned \
product_data_and_data_equivalence_relationship product_data_and_data_quality_relationship product_definition_formation_resource product_definition_occurrence \
product_definition_occurrence_reference product_definition_occurrence_reference_with_local_representation product_definition_reference \
product_definition_reference_with_local_representation product_definition_relationship_relationship product_definition_specified_occurrence \
product_definition_usage_relationship product_design_to_individual product_design_version_to_individual product_group product_group_attribute_assignment \
product_group_attribute_set product_group_attributes product_group_context product_group_membership product_group_membership_rules product_group_purpose \
product_group_relationship product_group_rule product_group_rule_assignment product_group_rules product_in_attachment_slot product_planned_to_realized \
product_relationship product_resource profile_floor protrusion quantifier_expression radius_geometric_constraint rationalize_function real_interval_from_min \
real_interval_to_max real_tuple_literal rectangular_area rectangular_array_placement_group_component rectangular_composite_surface_transition_locator \
regular_table_function reindexed_array_function removal_volume repackaging_function repositioned_neutral_sketch representation_proxy_item restriction_function \
rgc_with_dimension rib_top rib_top_floor rigid_subsketch rounded_end same_as_external_item_assignment scan_3d_model scan_data_shape_representation scanned_data_item \
scanner_basic_properties scanner_property sdgc_with_dimension selector_function self_intersecting_curve self_intersecting_geometry self_intersecting_loop \
self_intersecting_shell self_intersecting_surface series_composed_function shape_criteria_representation_with_accuracy shape_data_quality_assessment_by_logical_test \
shape_data_quality_assessment_by_numerical_test shape_data_quality_criteria_representation shape_data_quality_criterion \
shape_data_quality_criterion_and_accuracy_association shape_data_quality_inspected_shape_and_result_relationship shape_data_quality_inspection_criterion_report \
shape_data_quality_inspection_instance_report shape_data_quality_inspection_instance_report_item shape_data_quality_inspection_result \
shape_data_quality_inspection_result_representation shape_data_quality_lower_value_limit shape_data_quality_upper_value_limit shape_data_quality_value_limit \
shape_data_quality_value_range shape_feature_definition_element_relationship shape_feature_definition_fit_relationship shape_feature_definition_relationship \
shape_feature_fit_relationship shape_inspection_result_accuracy_association shape_inspection_result_representation_with_accuracy shape_measurement_accuracy \
...
single_property_is_definition single_texture_style_tessellation_specification skew_line_distance_geometric_constraint small_area_face small_area_surface \
small_area_surface_patch small_volume_solid software_for_data_quality_check solid_with_excessive_number_of_voids solid_with_wrong_number_of_voids spherical_cap \
SQL_mappable_defined_function standard_table_function state_definition_to_state_assignment_relationship state_observed state_observed_assignment \
state_observed_relationship state_observed_role state_predicted state_type state_type_assignment state_type_relationship state_type_role statechar_applied_object \
...
steep_angle_between_adjacent_edges steep_angle_between_adjacent_faces steep_geometry_transition_across_edge step strict_triangular_matrix structured_message \
su_parameters subsketch summary_report_request summary_report_request_with_number_of_instances \
...
surface_with_excessive_patches_in_one_direction surface_with_small_curvature_radius swept_curve_surface_geometric_constraint swept_point_curve_geometric_constraint \
symmetric_banded_matrix symmetric_matrix symmetry_geometric_constraint system_breakdown_context system_element_usage tangent_assembly_constraint \
tangent_geometric_constraint terminal_feature terminal_location_group texture_style_specification texture_style_tessellation_specification thermal_component \
...
topology_related_to_self_intersecting_geometry transformation_with_derived_angle transport_feature triangular_matrix turned_knurl \
twisted_cross_sectional_group_shape_element unbound_parameter_environment unbound_variational_parameter unbound_variational_parameter_semantics uniform_product_space \
unused_patches unused_shape_element validation validation_software_identification variable_expression variational_current_representation_relationship \
variational_parameter variational_representation verification verification_relationship volume wrong_element_name wrongly_oriented_void wrongly_placed_loop \
wrongly_placed_void zero_surface_normal zone_breakdown_context zone_element_usage]]
...
angle_direction_reference application_context application_context_element application_context_relationship application_protocol_definition applied_action_assignment \
applied_action_method_assignment applied_action_request_assignment applied_approval_assignment applied_area applied_attribute_classification_assignment \
applied_certification_assignment applied_classification_assignment applied_contract_assignment applied_date_and_time_assignment applied_date_assignment \
applied_document_reference applied_document_usage_constraint_assignment applied_effectivity_assignment applied_event_occurrence_assignment \
applied_external_identification_assignment applied_group_assignment applied_identification_assignment applied_ineffectivity_assignment applied_name_assignment \
applied_organization_assignment applied_organizational_project_assignment applied_person_and_organization_assignment applied_presented_item \
applied_security_classification_assignment applied_time_interval_assignment applied_usage_right approval approval_assignment approval_date_time \
approval_person_organization approval_relationship approval_role approval_status approximation_tolerance approximation_tolerance_deviation \
approximation_tolerance_parameter asin_function assembly_component_usage assembly_component_usage_substitute assigned_requirement atan_function atomic_formula \
attribute_assertion attribute_classification_assignment attribute_language_assignment attribute_value_assignment attribute_value_role \
...
breakdown_element_group_assignment breakdown_element_realization breakdown_element_usage breakdown_of calendar_date cc_design_approval cc_design_certification \
cc_design_contract cc_design_date_and_time_assignment cc_design_person_and_organization_assignment cc_design_security_classification \
cc_design_specification_reference certification certification_assignment certification_type change change_request characteristic_data_column_header \
characteristic_data_column_header_link characteristic_data_table_header characteristic_data_table_header_decomposition characteristic_type characterized_class \
characterized_object class class_by_extension class_by_intension class_system class_usage_effectivity_context_assignment classification_assignment \
classification_role comparison_equal comparison_expression comparison_greater comparison_greater_equal comparison_less comparison_less_equal comparison_not_equal \
complex_clause complex_conjunctive_clause complex_disjunctive_clause concat_expression concept_feature_operator concept_feature_relationship \
concept_feature_relationship_with_condition conditional_concept_feature configurable_item configuration_definition configuration_design configuration_effectivity \
configuration_interpolation configuration_item configuration_item_hierarchical_relationship configuration_item_relationship configuration_item_revision_sequence \
configured_effectivity_assignment configured_effectivity_context_assignment conical_stepped_hole_transition contact_ratio_representation contract \
contract_assignment contract_relationship contract_type coordinated_universal_time_offset cos_function currency data_environment date date_and_time \
date_and_time_assignment date_assignment date_role date_time_role dated_effectivity defined_function definitional_representation_relationship \
definitional_representation_relationship_with_same_context description_attribute design_context design_make_from_relationship \
dimension_curve_terminator_to_projection_curve_associativity directed_action directed_angle div_expression document document_file document_identifier \
document_identifier_assignment document_product_association document_product_equivalence document_reference document_relationship document_type \
document_usage_constraint document_usage_constraint_assignment document_usage_role double_offset_shelled_solid edge_blended_solid effectivity effectivity_assignment \
effectivity_context_assignment effectivity_context_role effectivity_relationship element_delivery entity_assertion enum_reference_prefix environment \
equals_expression evaluated_characteristic evaluation_product_definition event_occurrence event_occurrence_assignment event_occurrence_context_assignment \
event_occurrence_context_role event_occurrence_relationship event_occurrence_role exclusive_product_concept_feature_category executed_action exp_function \
expanded_uncertainty explicit_procedural_geometric_representation_item_relationship explicit_procedural_representation_item_relationship \
explicit_procedural_representation_relationship explicit_procedural_shape_representation_relationship expression expression_conversion_based_unit extent \
external_class_library external_identification_assignment external_source external_source_relationship externally_defined_picture_representation_item \
externally_defined_representation_item externally_defined_string externally_defined_tile extruded_face_solid_with_draft_angle \
extruded_face_solid_with_multiple_draft_angles extruded_face_solid_with_trim_conditions fact_type feature_in_panel featured_shape format_function \
forward_chaining_rule forward_chaining_rule_premise founded_item func functional_breakdown_context functional_element_usage \
functionally_defined_transformation general_feature generic_expression generic_variable geometric_model_element_relationship global_assignment ground_fact group \
group_assignment group_relationship hole_in_panel id_attribute identification_assignment identification_assignment_relationship identification_role \
included_text_block inclusion_product_concept_feature index_expression indirectly_selected_elements indirectly_selected_shape_elements information_right \
information_usage_right instance_usage_context_assignment int_literal int_numeric_variable int_value_function integer_defined_function \
interpolated_configuration_sequence interval_expression iso4217_currency joggle joggle_termination known_source language language_assignment length_function \
light_source light_source_ambient light_source_directional light_source_positional light_source_spot like_expression literal_conjunction literal_disjunction \
literal_number local_time locator log_function log10_function log2_function logical_literal lot_effectivity make_from_usage_option material_designation \
material_designation_characterization maximum_function mechanical_context mechanical_design_geometric_presentation_area \
mechanical_design_presentation_representation_with_draughting mechanical_design_shaded_presentation_area mechanical_design_shaded_presentation_representation \
minimum_function minus_expression minus_function mod_expression modified_pattern modified_solid modified_solid_with_placed_configuration motion_link_relationship \
mult_expression multi_language_attribute_assignment multiple_arity_boolean_expression multiple_arity_function_call multiple_arity_generic_expression \
multiple_arity_numeric_expression name_assignment name_attribute next_assembly_usage_occurrence not_expression numeric_defined_function numeric_expression \
numeric_variable object_role odd_function one_direction_repeat_factor or_expression ordinal_date organization organization_assignment organization_relationship \
organization_role organizational_address organizational_project organizational_project_assignment organizational_project_relationship organizational_project_role \
package_product_concept_feature partial_document_with_structured_text_representation_assignment pattern_offset_membership pattern_omit_membership person \
person_and_organization person_and_organization_address person_and_organization_assignment person_and_organization_role personal_address physical_breakdown_context \
physical_element_usage physically_modelled_product_definition picture_representation plus_expression point_path polar_complex_number_literal positioned_sketch \
power_expression pre_defined_presentation_style pre_defined_tile presented_item procedural_representation procedural_representation_sequence \
procedural_shape_representation procedural_shape_representation_sequence process_operation process_plan process_product_association process_property_association \
product product_category product_category_relationship product_class product_concept product_concept_context product_concept_feature \
product_concept_feature_association product_concept_feature_category product_concept_feature_category_usage product_concept_relationship product_context \
product_definition product_definition_context product_definition_context_association product_definition_context_role product_definition_effectivity \
product_definition_element_relationship product_definition_formation product_definition_formation_relationship product_definition_formation_with_specified_source \
product_definition_group_assignment product_definition_occurrence_relationship product_definition_process product_definition_relationship product_definition_resource \
product_definition_shape product_definition_substitute product_definition_usage product_definition_with_associated_documents product_identification \
...
promissory_usage_occurrence property_process qualitative_uncertainty quantified_assembly_component_usage range_characteristic real_defined_function real_literal \
real_numeric_variable relative_event_occurrence rep_item_group representation_item_relationship requirement_assigned_object requirement_assignment \
requirement_for_action_resource requirement_source requirement_view_definition_relationship resource_property resource_property_representation \
resource_requirement_type resulting_path retention revolved_face_solid_with_trim_conditions right_to_usage_association role_association row_value row_variable \
rule_action rule_condition rule_definition rule_set rule_set_group rule_software_definition rule_superseded_assignment rule_supersedence satisfied_requirement \
satisfies_requirement satisfying_item scalar_variable scattering_parameter sculptured_solid seam_edge security_classification security_classification_assignment \
security_classification_level serial_numbered_effectivity shape_defining_relationship shape_feature_definition simple_boolean_expression simple_clause \
simple_generic_expression simple_numeric_expression simple_string_expression sin_function slash_expression sourced_requirement specification_definition \
specified_higher_usage_occurrence sql_mappable_defined_function square_root_function standard_uncertainty start_request start_work string_defined_function \
string_expression string_literal string_variable structured_text_composition structured_text_representation substring_expression supplied_part_relationship symbol \
tan_function taper thickened_face_solid time_interval time_interval_assignment time_interval_based_effectivity time_interval_relationship time_interval_role \
time_interval_with_bounds track_blended_solid track_blended_solid_with_end_conditions transformation_with_derived_angle two_direction_repeat_factor \
unary_boolean_expression unary_function_call unary_generic_expression unary_numeric_expression uniform_resource_identifier usage_association user_selected_elements \
user_selected_shape_elements value_function variable variable_semantics versioned_action_request versioned_action_request_relationship week_of_year_and_day_date \
xor_expression year_month]]
