...
set pmiElementsMaxRows 155
# line breaks are above the row, depends on the grouping of PMI elements below
set pmiHorizontalLineBreaks [list 19 34 45 50 65 71 81 [expr {$pmiElementsMaxRows-4}] $pmiElementsMaxRows]
...
set dimSizeNames [list \
  ...
  "toroidal high major diameter" "toroidal low major diameter" "toroidal high major radius" "toroidal low major radius"]
...
set spmiTypes [concat $spmiTypes [list "document identification (3, see Header worksheet)" "dimensioning standard (4, Fig. 1)" \
                                       "modeling standard (4, Fig. 2)" "default tolerance decimal places (4.1)"]]
...
constituent_shape_aspect contact_feature contacting_feature continuous_shape_aspect counterbore_hole_occurrence counterbore_hole_occurrence_in_assembly \
...
shape_aspect_relationship shape_aspect_relationship_representation_association shape_aspect_transition spotface_occurrence spotface_occurrence_in_assembly \
...
thread_runout transition_feature turned_knurl vee_profile]]
...
maths_variable maths_variable_precision_qualifier mating_material mating_material_items mechanical_design_requirement_item_association message_contents_assignment \
