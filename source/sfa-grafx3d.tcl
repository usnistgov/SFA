...
proc x3dFileEnd {} {
  global ao brepFile brepFileName datumTargetView entCount nistModelURLs nistName
...
# B-rep part geometry
proc x3dBrepGeom {} {
  global brepFile brepFileName buttons defaultColor localName mytemp nistVersion opt viz wdir x3dApps x3dBbox x3dMax x3dMin x3dMsg x3dMsgColor x3dParts
...
# get DEF name of Group and use for Switch
                    ...
                    if {$c1 == $c2} {errorMsg " ERROR reading Group text string in the X3D file.  The View might be missing parts."}
                    incr npart
